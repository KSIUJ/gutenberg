...
from control.models import GutenbergJob, JobStatus, JobArtefact
...
def postprocess_postscript(input_file: str, work_dir: str, job: GutenbergJob, artefact:JobArtefact):
...
def postprocess_pwg(input_file: str, work_dir: str, job: GutenbergJob, artefact:JobArtefact):
...
def auto_postprocess(input_file: str, input_type: str, work_dir: str, job: GutenbergJob, artefact:JobArtefact):
    return {
        'application/pdf': postprocess_postscript,
        'application/postscript': postprocess_postscript,
        'image/pwg-raster': postprocess_pwg,
    }[input_type](input_file, work_dir, job, artefact)
