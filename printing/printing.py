...
def convert_to_pdf(filename):
    ...
    subprocess.check_call([SANDBOX_PATH, tmpdir, 'gs', '-sDEVICE=pdfwrite', '-dNOPAUSE', '-dBATCH', '-dSAFER', '-dCompatibilityLevel=1.4',
                          '-sOutputFile=' + tmpdir + '/final-unsized.pdf', out])
    subprocess.check_call([SANDBOX_PATH, tmpdir, 'pdfjam', '--outfile', tmpdir + '/final.pdf', '--paper', 'a4paper', tmpdir + '/final-unsized.pdf'])
